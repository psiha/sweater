...
#ifndef PSI_SWEATER_MAX_HARDWARE_CONCURRENCY
#   if defined( __EMSCRIPTEN__ ) && !defined( __EMSCRIPTEN_PTHREADS__ )
#       define PSI_SWEATER_MAX_HARDWARE_CONCURRENCY 1
#   elif defined( __ANDROID__ )
#       if defined( __aarch64__ )
#           define PSI_SWEATER_MAX_HARDWARE_CONCURRENCY 12 // Meizu PRO 6 10 cores
#       elif defined( __arm__ )
#           define PSI_SWEATER_MAX_HARDWARE_CONCURRENCY 8 // octa-low-v8-cores running as 32bit
#       else // x86 or MIPS
#           define PSI_SWEATER_MAX_HARDWARE_CONCURRENCY 4
#       endif // arch
#   elif defined( __APPLE__ )
#       include <TargetConditionals.h>
#       if defined( __aarch64__ ) && defined( __ENVIRONMENT_IPHONE_OS_VERSION_MIN_REQUIRED__ ) && !TARGET_OS_SIMULATOR
#           define PSI_SWEATER_MAX_HARDWARE_CONCURRENCY 24 // M2 Ultra running native iOS app via Catalyst
#       elif defined( __arm__ )
#           define PSI_SWEATER_MAX_HARDWARE_CONCURRENCY 2
#       else
#          define PSI_SWEATER_MAX_HARDWARE_CONCURRENCY 0 // desktop or simulator
#       endif // arch
#   elif defined(__WINDOWS_PHONE__)
#	    define PSI_SWEATER_MAX_HARDWARE_CONCURRENCY 2
#   else
#	    define PSI_SWEATER_MAX_HARDWARE_CONCURRENCY 0
#   endif // platform
